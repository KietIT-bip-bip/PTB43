...
#------------------------------
# chinh sua kieu string
print(fullName.lower()) # chuyen het ki tu thanh chu thuong
print(fullName.upper()) # chuyen het ki tu thanh chu hoa
print(fullName.capitalize()) # viet hoa trong chu cai dau tien trong sting
# -----------------------------
# tim vi tri xau con (find)
d_index = fullName.find("d")
print(d_index) # ko tra ve -1
# NOTE: find ( ki tu can tim, start, stop)
k_index = fullName.find("K", 4)# neu trung ky tu thi lay ky tu dau tien(start, stop)
print(k_index)
# -----------------------------
# str -> list (split)
...
#NOTE: neu ko co < so luong can thay > -> sua het
